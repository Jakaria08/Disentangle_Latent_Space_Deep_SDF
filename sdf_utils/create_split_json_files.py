...
obj_files_directory = '../../../CALSNIC/calsnic_pial_surface/mesh_dataset/pial_surface_R/obj_files'
...
with open('../examples/splits/split_CALSNIC_control_R/train_split_calsnic.json', 'w') as train_file:
    json.dump(train_files, train_file)
with open('../examples/splits/split_CALSNIC_control_R/val_split_calsnic.json', 'w') as val_file:
    json.dump(val_files, val_file)
with open('../examples/splits/split_CALSNIC_control_R/test_split_calsnic.json', 'w') as test_file:
