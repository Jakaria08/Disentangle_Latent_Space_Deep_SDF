...
import reconstruct
from networks.longitudinal_flow_64_160_32_pred_dx import build_temporal_flow
            ...
            for sdf_data, indices in sdf_loader:
                ...
                for i in range(batch_split):
                    ...
                    if use_age_conditioning:
                        ...
                        scan_ages = subject_gates.index_select(0, gate_inverse)
                    ...
                    if use_disentangled_velocity_flow:
                        ...
                        if use_age_conditioning:
                            ...
                            unique_scan_ages, _, _ = training_disease_gate(
                                temporal_flow,
                                unique_anchors,
                    ...
                    if (
                        ...
                        if unique_subjects.numel() > 0:
                            ...
                            if use_age_conditioning:
                                ...
                                consistency_condition, _, _ = training_disease_gate(
                                    temporal_flow,
                                    subject_anchors,
                                    consistency_targets,
                                    epoch=epoch,
                ...
                if epoch % eval_train_frequency == 0:
                    ...
                    for index in eval_train_scene_idxs:
                        ...
                        if use_age_conditioning:
                            ...
                            eval_age, _, _ = training_disease_gate(
                                temporal_flow,
                                subject_anchor,
                                eval_target,
                                epoch=epoch,
                ...
                if epoch % eval_test_frequency == 0:
                    ...
                    for sid in eval_test_subject_ids:
                        ...
                        if eval_disease_condition_mode == "oracle":
                            eval_disease_condition = subject_anchor.new_tensor(
                                [[true_diagnosis]]
                            )
                        elif eval_disease_condition_mode == "predicted_hard":
                            eval_disease_condition = predicted_hard
                        else:
                            eval_disease_condition = predicted_soft
