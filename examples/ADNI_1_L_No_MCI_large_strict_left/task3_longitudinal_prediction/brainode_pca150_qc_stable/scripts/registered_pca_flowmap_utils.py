...
from core_brainode_common import TASK_DIR, load_config, resolve_repo_path


DEFAULT_EXPERIMENT_NAME = "pca150_registered_flowmap_qc_v2"
...
def experiment_root(name: str = DEFAULT_EXPERIMENT_NAME) -> Path:
    return TASK_DIR.parent / str(name)
