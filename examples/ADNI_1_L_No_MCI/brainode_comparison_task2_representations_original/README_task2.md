...
This folder is an isolated representation pipeline for the original left
...
`inr/siren_naisr_enhanced/` for SIREN.
...
The original scaled coordinates are used without additional
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/audit_inputs.py
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/validate_task2.py --stage inputs
```
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/fit_export_pca.py
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/validate_task2.py --stage pca
```
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/train_inr_decoder.py \
  --config examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/configs/inr_deepsdf_eikonal.json \
  --device cuda:0
```
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/train_inr_decoder.py \
  --config examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/configs/inr_siren_eikonal.json \
  --device cuda:0
```
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/validate_task2.py --stage trained
```
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/fit_export_inr_latents.py \
  --config examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/configs/inr_deepsdf_eikonal.json \
  --checkpoint best \
  --device cuda:0 \
  --skip-existing
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/validate_task2.py --stage latents
```
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/reconstruct_inr_meshes.py \
  --config examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/configs/inr_deepsdf_eikonal.json \
  --checkpoint best \
  --device cuda:0 \
  --skip-existing
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/build_representation_manifest.py \
  --require-complete
```

## Step 7: Evaluate All Representations

This compares PCA-150, PCA-256, ReLU INR, and SIREN INR without ICP or other
post-reconstruction alignment:

```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/evaluate_reconstructions.py
```
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/compare_inr_models.py
```
...
```bash
python examples/ADNI_1_L_No_MCI/brainode_comparison_task2_representations_original/scripts/validate_task2.py --stage complete
```
