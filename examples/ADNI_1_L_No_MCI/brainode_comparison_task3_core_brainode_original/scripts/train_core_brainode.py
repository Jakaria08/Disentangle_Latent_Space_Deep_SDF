...
from brainode_model import ODEFuncWithAttention, integrate_sequence_rk4
...
def build_trajectory_records(
    ...
    for sequence in sequences:
        ...
        condition = float(sequence["condition"])
...
def train_one_epoch(
    ...
    for _, loader in loaders:
        for batch in loader:
            ...
            loss = full_trajectory_pca_mse(prediction, augmented_targets)
    ...
    return {
        "train_full_pca_mse": total_loss / max(total_trajectories, 1),
