...
def create_mesh(decoder, kl_div_loss, train_surface_points, latent_vec, filename=None, N=256, max_batch=32 ** 3, offset=None, scale=None, return_trimesh=False, return_latent=False) -> Optional[trimesh.Trimesh]:
    ...
    while head < num_samples:
        ...
        sdf, z = utils.decode_sdf(decoder, kl_div_loss, train_surface_points, latent_vec, sample_subset)
