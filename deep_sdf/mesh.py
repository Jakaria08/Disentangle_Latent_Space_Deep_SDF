...
def create_mesh(decoder, latent_vec, filename=None, N=512, max_batch=32 ** 3, offset=None, scale=None, return_trimesh=False) -> Optional[trimesh.Trimesh]:
    ...
    With settings N=512 and max_batch=int(2 ** 18) this takes about 10sec on GPU and 100sec on the CPU.
    """
    start = time.time()
